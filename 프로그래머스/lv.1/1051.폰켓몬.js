...
this represents that there are two ponketmons of number 3, one ponketmon of number 1, 
and one ponketmon of number 2. 
...
write a function "solution" to find the way to select and 
return the maximum number of types you can get.
